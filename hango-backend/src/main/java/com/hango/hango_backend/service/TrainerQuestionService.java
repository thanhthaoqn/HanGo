...
public interface TrainerQuestionService {
    List<QuestionDTO> getTrainerQuestions(String email, String type, String search, String sortBy, Long skillId, Long categoryId, Long difficultyId, Integer usageType, Long groupTypeId);
