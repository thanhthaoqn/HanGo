...
public class EmailService {
    ...
    public void sendSettlementPaidEmail(String toEmail, String trainerName, String periodMonth, String netPayoutText,
        ...
        final String htmlContent = "<!DOCTYPE html>"
                ...
                + "                <tr>"
                + "                  <td align=\"center\" style=\"padding-bottom: 12px;\">"
                + "                    <h1 style=\"margin: 0; color: #0f172a !important; font-size: 22px; font-weight: 800; text-align: center;\">Xác nhận Quyết toán Doanh thu</h1>"
                + "                  </td>"
                + "                </tr>"
                + "                <tr>"
                + "                  <td align=\"center\" style=\"padding-bottom: 24px;\">"
                + "                    <p style=\"margin: 0; color: #334155 !important; font-size: 15px; line-height: 1.6; text-align: center;\">"
                + "                      Xin chào <strong style=\"color: #0d9488 !important;\">" + safeName + "</strong>, khoản thanh toán doanh thu giảng dạy kỳ <strong>" + safePeriod + "</strong> của bạn đã được đối soát và chuyển khoản thành công vào tài khoản ngân hàng."
                + "                    </p>"
                + "                  </td>"
                + "                </tr>"
                + "              </table>"
                ...
                + "                      </tr>"
                + "                      <tr>"
                + "                        <td style=\"color: #64748b !important; font-size: 14px; font-weight: 600; padding: 8px 0;\">Mã tham chiếu GD:</td>"
                ...
                + "                        <td align=\"right\" style=\"padding: 8px 0;\"><span style=\"color: #059669; font-weight: 700; font-size: 13px;\">● Đã hoàn tất (PAID)</span></td>"
                + "                      </tr>"
        ...
        try {
            ...
            log.warn("Could not send revenue settlement HTML email: {}", e.getMessage());
        }
    }
}
