...
public class EmailService {
    ...
    public void sendEnrollmentSuccessEmail(String toEmail, String learnerName, String courseTitle, String priceText,
        ...
        final String htmlContent = "<!DOCTYPE html>"
                ...
                + "              <img src=\"https://res.cloudinary.com/diqekap4o/image/upload/v1781621071/logo_ayqvq4.png\" alt=\"HanGo Logo\" style=\"height: 54px; width: auto; display: block; margin: 0 auto;\">"
                + "            </td>"
                + "          </tr>"
                + "          <tr>"
