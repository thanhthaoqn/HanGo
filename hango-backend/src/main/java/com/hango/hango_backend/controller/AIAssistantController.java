...
@CrossOrigin(origins = "http://localhost:3000", allowCredentials = "true") // ✨ THÊM DÒNG NÀY ĐỂ FIX LỖI CORS CHO FLUTTER WEB
public class AIAssistantController {
    ...
    /** Hàm helper lấy UserId từ Security Context một cách an toàn, tránh ClassCastException */
    private Long getSafeUserId() {
        try {
            ...
            // 6. Cứu cánh cuối cùng: Nếu principal là object lạ (UserDetails mặc định của Spring), thử lấy username/email
