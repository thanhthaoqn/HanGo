...
void main() {
  group('AuthService.getStoredSession', () {
    ...
    test('rebuilds a session from the same keys AuthService.getToken()/saveSession() use', () async {
      SharedPreferences.setMockInitialValues({
        'auth_token': 'jwt-123',
        'user_id': 42,
    ...
    test('falls back to LEARNER when roles list has no admin/manager/trainer role', () async {
      SharedPreferences.setMockInitialValues({
