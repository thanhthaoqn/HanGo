...
class _CreateCoursePageState extends State<CreateCoursePage> {
  ...
  List<Map<String, dynamic>> _dbCategories = [
    {'paramKey': 'PHONETICS', 'paramValue': 'Phonetics'},
    {'paramKey': 'WORD_ORDER', 'paramValue': 'Word order'},
    {'paramKey': 'REDUCED_RELATIVE_CLAUSE', 'paramValue': 'Reduced relative clause'},
    {'paramKey': 'PREPOSITION', 'paramValue': 'Preposition'},
    {'paramKey': 'COLLOCATION', 'paramValue': 'Collocation'},
    {'paramKey': 'TO_INFINITIVE', 'paramValue': 'To-infinitive'},
    {'paramKey': 'QUANTIFIER', 'paramValue': 'Quantifier'},
    {'paramKey': 'PHRASAL_VERB', 'paramValue': 'Phrasal verb'},
    {'paramKey': 'PREPOSITIONAL_PHRASE', 'paramValue': 'Prepositional phrase'},
    {'paramKey': 'VOCABULARY', 'paramValue': 'Vocabulary'},
    {'paramKey': 'CONVERSATION_ORDERING', 'paramValue': 'Conversation ordering'},
    {'paramKey': 'LETTER_ORDERING', 'paramValue': 'Letter ordering'},
    {'paramKey': 'PARAGRAPH_ORDERING', 'paramValue': 'Paragraph ordering'},
    {'paramKey': 'PASSIVE_VOICE', 'paramValue': 'Passive voice'},
    {'paramKey': 'RELATIVE_CLAUSE', 'paramValue': 'Relative clause'},
    {'paramKey': 'CONTEXTUAL_MEANING', 'paramValue': 'Contextual meaning'},
    {'paramKey': 'FACTUAL_DETAIL_QUESTION', 'paramValue': 'Factual / Detail question'},
    {'paramKey': 'SYNONYM_IN_CONTEXT', 'paramValue': 'Synonym in context'},
    {'paramKey': 'ANTONYM_IN_CONTEXT', 'paramValue': 'Antonym in context'},
    {'paramKey': 'REFERENCE_QUESTION', 'paramValue': 'Reference question'},
    {'paramKey': 'PARAPHRASING_QUESTION', 'paramValue': 'Paraphrasing question'},
    {'paramKey': 'PARAGRAPH_SPECIFIC_INFORMATION_QUESTION', 'paramValue': 'Paragraph-specific information question'},
    {'paramKey': 'MAIN_IDEA_CENTRAL_THEME_QUESTION', 'paramValue': 'Main idea / Central theme question'},
    {'paramKey': 'TRUE_NOT_TRUE_QUESTION', 'paramValue': 'TRUE / NOT TRUE question'},
    {'paramKey': 'INFERENCE_QUESTION', 'paramValue': 'Inference question'},
  ];
